...
namespace System.Net.Proxy
{
    public class WebProxy : IWebProxy
    {
        ...
        public WebProxy(Uri Address, bool BypassOnLocal, string[] BypassList, ICredentials Credentials)
        {
            ...
            if (BypassList != null)
            {
                _bypassList = new List<string>(BypassList);
        ...
        {
            get { return _bypassList != null ? _bypassList.ToArray() : Array.Empty<string>(); }
            set
            {
                _bypassList = new List<string>(value);
                UpdateRegExList(true);
            }
        }

        public List<string> BypassArrayList => _bypassList ?? (_bypassList = new List<string>());
        ...
        private void UpdateRegExList(bool canThrow)
        {
            ...
            List<string> bypassList = _bypassList;
            try
            {
                if (bypassList != null && bypassList.Count > 0)
                {
                    ...
                    {
                        regExBypassList[i] = new Regex(bypassList[i], RegexOptions.IgnoreCase | RegexOptions.CultureInvariant);
                    }
                }
            }
            catch
